...
public class MyDonateBloodHistoryModel {



    String Id,BloodReqId,RequesterId,UserId,UserName,ContactNo,City,Area,Address,Pincode,UserImage,BloodType,ActionDate,ActionStatus,Status,IsRequetClear;
